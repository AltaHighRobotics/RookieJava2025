...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    addStateBinding(9,  StateConstants.ALGAE_LEVEL_TWO_HEIGHT,   StateConstants.ALGAE_LEVEL_TWO_ROTATION);          // Medium level Algae [HEIGHT IS WRONG]   Height: 0.7    Rotation: -69
    addStateBinding(10, StateConstants.CORAL_LEVEL_TWO_HEIGHT,   StateConstants.CORAL_LEVEL_TWO_ROTATION);          // Medium level coral                     Height: 0.7    Rotation: -69
    addStateBinding(11, StateConstants.ALGAE_LEVEL_ONE_HEIGHT,   StateConstants.ALGAE_LEVEL_ONE_ROTATION);          // Low level Algae [HEIGHT IS WRONG]      Height: 0.4    Rotation: -69
    addStateBinding(12, StateConstants.CORAL_LEVEL_ONE_HEIGHT,   StateConstants.CORAL_LEVEL_ONE_ROTATION);          // Low level coral                        Height: 0.0    Rotation: -69
  }
