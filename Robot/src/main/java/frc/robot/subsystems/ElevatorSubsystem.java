...
public class ElevatorSubsystem extends SubsystemBase{
    ...
    public void moveToTargetHeight() { // Meant to be called each tick
        ...
        this.targetHeightPercentage = MathUtil.clamp(targetHeightPercentage, 0.03, 0.9); // The low can go to 0.02 but we won't for safety, but the max of the elevator MUST be 0.9
